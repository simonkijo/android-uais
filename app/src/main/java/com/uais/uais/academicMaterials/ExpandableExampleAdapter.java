...
import com.uais.uais.academicMaterials.common.widget.ExpandableItemIndicator;
...
class ExpandableExampleAdapter
    ...
    public void setOnItemClickListener(OnRecyclerViewItemClickListener listen){
    ...
    @Override
    public void onBindChildViewHolder(MyChildViewHolder holder, int groupPosition, final int childPosition, int viewType) {
        // group item
        ...
        holder.mContainer.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                listener.onRecyclerViewItemClicked(childPosition,v.getId(),item.getText());
            }
        });
